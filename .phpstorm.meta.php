...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.uploads.driver' => 'string',
            'filesystems.disks.uploads.root' => 'string',
            'filesystems.disks.uploads.url' => 'string',
            'filesystems.disks.uploads.visibility' => 'string',
            'filesystems.links./home/mohanad/gsg-php/gsg-classroom/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.uploads.driver','filesystems.disks.uploads.root','filesystems.disks.uploads.url',
'filesystems.disks.uploads.visibility','filesystems.links./home/mohanad/gsg-php/gsg-classroom/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','profile.edit','profile.update',
...
'logout','classrooms.trashed','classrooms.restore','classrooms.force-delete','topics.index',
'topics.create','topics.store','topics.show','topics.edit','topics.update',
'topics.destroy','classrooms.index','classrooms.create','classrooms.store','classrooms.show',
'classrooms.edit','classrooms.update','classrooms.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','classrooms._form','classrooms.create','classrooms.edit','classrooms.index',
'classrooms.show','classrooms.trashed','classrooms.update','components.alert','components.application-logo',
'components.auth-session-status','components.danger-button','components.dropdown','components.dropdown-link','components.form.error',
'components.form.floating-control','components.form.input','components.input-error','components.input-label','components.main-layout',
...
'components.text-input','dashboard','layouts.app','layouts.guest','layouts.main',
'layouts.master','layouts.navigation','login','partials.footer','partials.header',
